    ...
    return (
        <div className="w-full h-full flex justify-center">
            <div
                ...
                className="relative bg-gradient-to-t from-pink-900 to-pink-500 rounded-3xl overflow-hidden
                shadow-sm hover:shadow-md transition-all cursor-pointer w-[300px] max-w-[300px] h-80 flex flex-col"
            >
