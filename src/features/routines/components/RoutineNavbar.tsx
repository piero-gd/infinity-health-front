...
export default function RoutineNavbar({ onLogout }: { onLogout: () => void }) {
  return (
    <nav className="sticky top-0 z-10 flex items-center bg-gray-800 px-4 py-3 shadow">
      ...
      <div className="flex items-center gap-6">
        ...
        <button onClick={onLogout} className="flex items-center gap-1 text-gray-300 hover:text-white transition">
