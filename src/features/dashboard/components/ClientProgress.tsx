...
export default function ClientProgress() {
 ...
 <div className="rounded-2xl bg-white px-4 py-3 border border-gray-100 shadow-sm mb-5">
                ...
                <div className="bg-gray-100 rounded-2xl py-4 p-5 px-3 ">
                    <div className="flex items-center gap-4 ">
                        <div className="flex-1 bg-gray-200 rounded-full h-3 overflow-hidden">
                            <div className="bg-gradient-to-br from-[var(--color-btn-gradient-bottom)] to-[var(--color-btn-gradient-top)] h-full rounded-full w-[70%] transition-all duration-500"></div>
                        </div>
            ...
            {/* Bottom Grid */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 h-full flex-grow">
               {/* Favorite Training  */}
            <div className="rounded-2xl bg-white p-4 border border-gray-100 shadow-sm flex flex-col h-full">
                <h3 className="font-medium text-gray-900 lg:mb-0 mb-3 text-center sm:text-left">Entrenamiento Favorito</h3>
                <span className="text-md font-medium text-primary underline mb-3 lg:mb-3 mt-3 lg:mt-2 xl:mt-4 block text-center sm:text-left">Flexiones (Push-ups)</span>
                                
                <div className="mb-4 lg:mb-0">
                    <div className="flex flex-col sm:flex-row sm:items-baseline gap-2 mb-2 xl:mt-3 lg:mb-0 lg:mt-0 mt-3 items-center">
                ...
                {/* AreaChart */}
                <div className="xl:block lg:hidden xl:mt-5">
                <div className="relative h-12 mb-1 flex-grow ">
                ...
                <div className="rounded-2xl bg-white p-4 border border-gray-100 shadow-sm flex flex-col h-full">
                    ...
                    <p className="text-gray-600 text-sm mb-2 flex-1 xl:block lg:hidden">
