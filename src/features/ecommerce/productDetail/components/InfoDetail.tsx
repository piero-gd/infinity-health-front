...
export const InfoDetail: React.FC<InfoDetailProps> = ({ 
    ...
    return (
        <div className="xl:p-5 p-0 md:p-6">
            ...
            {/* BOTONES */}
            <div className="flex flex-row gap-4 mt-8 mb-0 xl:mb-10 xl:relative md:relative fixed bottom-0 left-0 right-0 xl:z-auto z-10 xl:p-0 p-8 xl:bg-transparent xl:rounded-none rounded-t-3xl xl:border-none border-2 border-white bg-white/89 md:bg-transparent md:border-none backdrop-blur-sm justify-center xl:justify-start">
