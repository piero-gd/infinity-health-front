...
// Interfaces para la función de búsqueda
...
/**
 * Implementación con datos mock para obtener productos
 * Mantiene la misma firma que fetchProducts para compatibilidad
 */
...
/**
 * Implementación con datos mock para obtener un producto por ID
 */
export const fetchMockProductById = async (id: number): Promise<Product | null> => {
...
/**
 * Implementación con datos mock para obtener un producto por slug
 */
export const fetchMockProductBySlug = async (slug: string): Promise<Product | null> => {
  // Simular latencia de red
  await new Promise(resolve => setTimeout(resolve, 300));
