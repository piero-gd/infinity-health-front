        ...
        <div className="bg-white rounded-3xl p-6">
          ...
          <div className="flex justify-between items-center">
            <span className="text-gray-700 font-medium">Subtotal:</span>
              ...
              <div className="flex items-center">
                <span className="text-gray-500 line-through mr-2">56</span>
                <span className="text-[var(--color-primary)] font-semibold">56</span>
          ...
          <div className="flex justify-between items-center">
            ...
            <span className="text-2xl font-bold text-blue-600">
                ...
                <div className="flex items-center">
                  <span className="text-gray-500 line-through text-lg mr-2">56</span>
                  <span className="text-[var(--color-primary)]">56</span>
                </div>
